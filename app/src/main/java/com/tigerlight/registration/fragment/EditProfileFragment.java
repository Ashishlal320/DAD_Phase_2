...
import com.tigerlight.BuildConfig;
import com.tigerlight.DADApplication;
import com.tigerlight.R;
import com.tigerlight.cropimage.CropImage;
import com.tigerlight.home.BaseFragment;
import com.tigerlight.registration.model.GetUserInfoModel;
import com.tigerlight.registration.util.Constant;
import com.tigerlight.registration.util.Utills;
import com.tigerlight.registration.webservices.WsCallForgotPassword;
import com.tigerlight.settings.webservices.WsCallChangePassword;
import com.tigerlight.settings.webservices.WsCallUpdateAccount;
import com.tigerlight.settings.webservices.WsGetUserData;
import com.tigerlight.settings.webservices.WsUploadImage;
import com.tigerlight.simplecropping.CameraUtil;
import com.tigerlight.simplecropping.Constants;
    ...
    private void displayDialog(final Activity context, final String title, final String msg, final String strPositiveText) {
        ...
        dialog.setPositiveButton(strPositiveText, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                intent.putExtra(com.tigerlight.util.Constants.Extras.FORCE_LOGOUT, true);
                getTargetFragment().onActivityResult(com.tigerlight.util.Constants.REQUEST_CODES.FORCE_LOGOUT, RESULT_OK, intent);
